...
class SubCategoryViewModel extends BaseViewModel{
  ...
  SubCategoryViewModel({this.context,this.categoryId,this.textEditingController}): super(context: context){
    getSubcategories();
  }
  ...
  List<String> subcategories = ['پارچه','رنگ','یراق آلات','پارچه','یراق آلات','یراق آلات','یراق آلات'];
  void getSubcategories() async{
    subCategoriesListView =  ListView.builder(

      scrollDirection: Axis.horizontal,
        itemCount: subcategories.length, itemBuilder: (context,i){
      return Container(
        ...
        child: Text(subcategories[i],style: kTitleTextStyle.copyWith(color: kAccentColor),),
      );
    });
